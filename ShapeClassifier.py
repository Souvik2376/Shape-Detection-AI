...
class DrawingClassifier:
    ...
    def init_gui(self):
        ...
        self.root = Tk()
        self.root.title(f" Shape Classifier - {self.proj_name}")
    ...
    def predict(self):
        ...
        if prediction[0] == 1:
            tkinter.messagebox.showinfo(" Shape Classifier", f"The drawing is probably a {self.class1}", parent=self.root)
        elif prediction[0] == 2:
            tkinter.messagebox.showinfo(" Shape Classifier", f"The drawing is probably a {self.class2}", parent=self.root)
        elif prediction[0] == 3:
            tkinter.messagebox.showinfo(" Shape Classifier", f"The drawing is probably a {self.class3}", parent=self.root)
    ...
    def save_model(self):
        ...
        tkinter.messagebox.showinfo(" Shape Classifier", "Model successfully saved!", parent=self.root)

    def load_model(self):
        file_path = filedialog.askopenfilename()
        with open(file_path, "rb") as f:
            self.clf = pickle.load(f)
        tkinter.messagebox.showinfo(" Shape Classifier", "Model successfully loaded!", parent=self.root)
    ...
    def save_everything(self):
        ...
        with open(f"{self.proj_name}/{self.proj_name}_data.pickle", "wb") as f:
            pickle.dump(data, f)
        tkinter.messagebox.showinfo(" Shape Classifier", "Project successfully saved!", parent=self.root)
